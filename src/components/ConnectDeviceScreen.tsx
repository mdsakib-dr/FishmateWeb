import { ArrowLeft, Wifi, Loader2, Check, Menu } from 'lucide-react';
...
export function ConnectDeviceScreen({ onNavigate }: ConnectDeviceScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#d4e3ea] to-[#f5f8fa] relative">
      {/* Responsive Sidebar */}
      <ResponsiveSidebar
      ...
      <div className="flex-1 flex flex-col pb-16 md:pb-0">
        ...
        <div className="bg-white shadow-sm sticky top-0 z-20 border-b border-[#e8eef2]">
          <div className="p-4 md:p-6 flex items-center gap-3 max-w-7xl mx-auto">
            ...
            <h1 className="text-[#1e5f74] text-xl md:text-2xl lg:text-3xl">Connect New Device</h1>
          </div>
        </div>
