import { ArrowLeft, User, Mail, Phone, MapPin, Calendar, Edit2, Camera } from 'lucide-react';
...
export function ProfileScreen({ onNavigate }: ProfileScreenProps) {
  return (
    <div className="h-full bg-[#f5f8fa] overflow-y-auto relative pb-6">
      {/* Header */}
      <div className="bg-white shadow-sm sticky top-0 z-10 pt-11 border-b border-[#e8eef2]">
        <div className="p-4 flex items-center gap-3">
          ...
          <h1 className="text-[#1e5f74] text-xl">My Profile</h1>
        </div>
      </div>
